...
echo "<p>",
str_replace(["Pink Floyd", "incrível"],
...
var_dump($aluno);
echo "<p> Olá! Meu nome é {$aluno->name} e meu e-mail é <a href='malito:{$aluno->email}?subject=Dúvidas&body=Corpo do e-maail www.zen.ppg.br'>{$aluno->email} </a> e eu tenho {$aluno->age} anos </p>";