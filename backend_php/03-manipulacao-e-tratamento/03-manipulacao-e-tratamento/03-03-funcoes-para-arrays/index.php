...
<p>{{company}}</p>
<span class="tag">
<a href="mailto:{{email}}?subject=Enviando e-mail pelo Template" 
tittle="Enviar e-mail para {{name}}"> Enviar e-mail! </a>
</span>
</article>
TPL;
...
echo str_replace(array_keys($profile),
array_values($profile), $template);
