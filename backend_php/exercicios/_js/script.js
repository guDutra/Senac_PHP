$(function () {
    ...
    $('html').on('change', 'form.auto_save', function (e) {
        ...
        console.log(BASE + '/_ajax/' + callback + '.ajax.php')
        form.ajaxSubmit({
        ...
        form.ajaxSubmit({
            ...
            success: function (data) {
                ...
                form.find('.form_load').fadeOut('slow', function () {
                    ...
                    if (data.result11) {
                        $("#result11").html("<p> " + data.result11 + "</p>");
                    }

                    if (data.result12) {
                        $("#result12").html("<p> " + data.result12 + "</p>");
                    }

                    if (data.result13) {
                        $("#result13").html("<p> " + data.result13 + "</p>");
                    }
                    
                    if (data.result14) {
                        $("#result14").html("<p> " + data.result14 + "</p>");
                    }   
                    
                    if (data.result15) {
                        $("#result15").html("<p> " + data.result15 + "</p>");
                    }5
